...
public class OrderServiceImpl implements OrderService
{
    ...
    public void create(Order order)
    {
        ...
        if(result > 0)
        {
            ...
            System.out.printf("--------------"+String.valueOf(orderFromDB.getProductId()),orderFromDB.getCount());
            ...
            System.out.printf("----------"+String.valueOf(orderFromDB.getUserId()),orderFromDB.getMoney());
